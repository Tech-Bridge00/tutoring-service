...
public class TutoringCommandController {
    ...
    // 과외 신청
    @PostMapping
    public CommonResponse<Void> requestTutoring(
    ...
    public CommonResponse<Void> acceptTutoring(
    ...
    public CommonResponse<Void> rejectTutoring(
        @PathVariable Long tutoringId,
        @AuthenticationPrincipal LoginMember loginMember
    ) {
    ...
    public CommonResponse<Void> cancelTutoring(
        @PathVariable Long tutoringId,
        @AuthenticationPrincipal LoginMember loginMember
    ) {
